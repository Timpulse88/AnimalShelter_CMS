...
{	
	...
	//include "page_content.php";
	$rPage = mysql_query("SELECT * FROM FEATURED ORDER BY ADOPTED, RAND() LIMIT 36");
	if($rPage) 			
	{
		...
		{												
			...
			if($PICTURE != "")
			{
				...
				{						
					...
					echo "<a class='gallery-touch' href='featured.php?Name=$ANIMAL_NAME&ID=$AID' title='Read more about $ANIMAL_NAME'><img src='$Photo' class='img-responsive' style='height: 100%; width: auto;' alt='Read more about $ANIMAL_NAME'></a>\n";
					echo "<div class='photo-info'><a class='gallery-touch' href='featured.php?Name=$ANIMAL_NAME&ID=$AID' title='Read more about $ANIMAL_NAME'><h4>Hi, I'm $ANIMAL_NAME!</h4><span><br>Will you take me home?</span></a>\n";
					...
					//echo "<a href='featured.php?Name=$ANIMAL_NAME&ID=$AID' title='Read more about $ANIMAL_NAME'>More about $ANIMAL_NAME</a>\n";
...
<!-- Space for Translucent Menu at top -->
	...
	<div style="background-color:rgb(255,215,93); height:125px;">
			...
			<div class="row">
				<div class="col-sm-6">
					...
					if($LOCATION=="P")
						...
						echo "<p>Read more <a href='featured.php' title='Adoption Success Stories and Featured Pets at ANIMAL SHELTER'>Adoption Success Stories and View Featured Pets</a> here.</p>\n";
					?>
				</div>
