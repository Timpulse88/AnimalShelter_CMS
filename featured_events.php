		...
		{												
			...
			if($PICTURE != "")
			{
				...
				{						
					...
					echo "<div class='photo-info'><a class='gallery-touch' href='featured.php?Name=$ANIMAL_NAME&ID=$AID' title='Read more about $ANIMAL_NAME'><h4>Hi, I'm $ANIMAL_NAME!</h4></a>\n";
