...
$(document).ready(function($) {
	...
	$('.style-chooser2 .toggler2').on('click', function(event){
		event.preventDefault();
		$(this).closest('.style-chooser2').toggleClass('opened');
	});	
	
	//CSS Append (pre-designed) Color Theme Change	
	...
	//Javascript for toggler Donate button
	function $clickDonate ()
		{
			/*$('.style-chooser .toggler').on('click', function(event){
			event.preventDefault();*/
			//$(this).closest('.style-chooser').toggleClass('opened');
    		document.getElementById("Donate").toggleClass('opened');			
			//});
		}
});
